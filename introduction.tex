...
In this dissertation, I will take the empirical approach 
...
%As a third-party, I only have limited access to threat intelligence data
%or its use case scenarios. However, by accumulating the data over a long period 
%of time, associating threat intelligence with external data sources, and
%using indirect inferring techniques, I have shown that one can increase his
%footing during threat intelligence studies and learn valuable lessons from 
%empirical analyses. 
