...
%This ``now and past'' intersection between feeds could potentially introduce bias
%when comparing the high-level characteristic of two datasets. Therefore, we excluded the
%old data from each feed and redid the volume, intersection and accuracy analyses.
%The results are essentially unchanged, indicating that the overlapping data was not
%the cause of the consistency of our analyses over time.
%The comparison above show the changes between feeds over the time, yet the high level characteristic
